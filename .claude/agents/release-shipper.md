...
|---|---|---|---|
| `cue-card-rehearsal-auditor` | `examples/cohort_demo/realistic/CUE_CARD.md`, `src/tailor/children/**/child.py`, `src/tailor/framework/vault/layer.py`, `src/tailor/framework/local_llm/layer.py` (any file declaring `ToolDefinition` schemas) | seconds | attestation-required |
