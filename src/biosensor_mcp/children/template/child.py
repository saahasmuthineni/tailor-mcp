...
========================================================
Copy this file to ``src/biosensor_mcp/children/<yourdomain>/child.py``,
...
``src/biosensor_mcp/children/running/child.py``. This template is
...
# ``biosensor_mcp.framework.storage`` for a thread-safe SQLite
